        ...
        try:
            ...
            while cap.isOpened():
                ...
                try:
                    ...
                    # Extended ankle-knee line
                    extended_leg_points = self.extend_line_to_frame(ankle_px, knee_px, w, h)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Process video with hack squat form analysis and extended lines.')
    parser.add_argument('--input', type=str, default="/Users/kevinrooster/Downloads/hacksquat.mov", help='Input video path')
    parser.add_argument('--output', type=str, default="analyzed_hacksquat_line", help='Output video path')
    ...
    analyzer = HackSquatAnalyzerLine()
